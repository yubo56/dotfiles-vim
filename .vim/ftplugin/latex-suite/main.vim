...
if !exists('s:doneMappings')
	...
	"own commands
	call IMAP ('\cc', '\c{c}', "tex")
	call IMAP (g:Tex_Leader.'<', '\bra{<++>}<++>', 'tex')
	call IMAP (g:Tex_Leader.'9', '\div ', 'tex')
	call IMAP (g:Tex_Leader.'C', '\hat{<++>}<++>', 'tex')
	call IMAP (g:Tex_Leader.'J', '\binom{<++>}{<++>}<++>', 'tex')
	call IMAP (g:Tex_Leader.'K', '\mathfrak{<++>}<++>', 'tex')
	call IMAP (g:Tex_Leader.'3', '\mathrm{<++>}<++>', 'tex')
	call IMAP (g:Tex_Leader.'#', '\mathbb{<++>}<++>', 'tex')
	call IMAP (g:Tex_Leader.'N', '\nabla', 'tex')
	call IMAP (g:Tex_Leader.'>', '\ket{<++>}<++>', 'tex')
	call IMAP (g:Tex_Leader.'6', '\pd{<++>}{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'5', '\rd{<++>}{<++>}<++>', "tex")
	call IMAP ('-->', '\to', "tex")
	call IMAP ('CAL', '\mathcal{<++>}<++>', "tex")
	call IMAP ('SCN', '\scinot{<++>}{<++>}<++>', "tex")
	call IMAP ('LBL', '\label{<++>}<++>', "tex")
	call IMAP ('REF', '\eqref{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'B', '\mathbf{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'v', '\vec{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'V', '\pvec{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'H', '\hbar', 'tex')
	call IMAP (g:Tex_Leader.',', '\propto', "tex")
	call IMAP (g:Tex_Leader.'j', '\expvalue{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'%', '\rtd{<++>}{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'^', '\ptd{<++>}{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'(', '\begin{pmatrix} <++> \end{pmatrix} <++>', "tex")
	call IMAP (g:Tex_Leader.'[', '\begin{bmatrix} <++> \end{bmatrix} <++>', "tex")
	call IMAP ('!=', '\neq', "tex")
	call IMAP ('+-', '\pm', "tex")
	call IMAP (g:Tex_Leader.'I', '\int\limits_{<++>}^{<++>}<++>\;<++>', 'tex')
	call IMAP ('-+', '\mp', "tex")
	...
	call IMAP ('||', '\abs{<++>}<++>', "tex")
	call IMAP ('<>', '\dotp{<++>}{<++>}<++>', "tex")
	call IMAP (g:Tex_Leader.'+', '^\dagger', "tex")
	 call IMAP (g:Tex_Leader.'_', '\overline{<++>}<++>', "tex")
	...
	call IMAP (g:Tex_Leader.'M', '\sum\limits_{<++>}^{<++>}<++>', 'tex')
	...
	call IMAP (g:Tex_Leader.'|', '\Bigg|', "tex")
	" }}}
	" Greek Letters {{{
